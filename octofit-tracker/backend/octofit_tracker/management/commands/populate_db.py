...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create teams
        teams = [
            Team(_id=ObjectId(), name='Blue Team', members=[users[0], users[2], users[4]]),
            Team(_id=ObjectId(), name='Gold Team', members=[users[1], users[3]]),
        ]
        for team in teams:
            team.save()
        ...
        # Create workouts
        workouts = [
            Workout(_id=ObjectId(), name='Cycling Training', description='Road cycling event training', duration=60),
            Workout(_id=ObjectId(), name='Crossfit', description='Crossfit competition training', duration=120),
            Workout(_id=ObjectId(), name='Running Training', description='Marathon training', duration=90),
            Workout(_id=ObjectId(), name='Strength Training', description='Strength improvement training', duration=30),
            Workout(_id=ObjectId(), name='Swimming Training', description='Swimming competition training', duration=75),
        ]
